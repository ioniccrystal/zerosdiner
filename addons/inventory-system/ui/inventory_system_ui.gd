...
func _open_player_inventory(show_equipment:bool = true):
	# 修改过，工作台时不显示装备栏
	if player_inventories_ui:
		player_inventories_ui[0].visible = true
		player_inventories_ui[1].visible = show_equipment
